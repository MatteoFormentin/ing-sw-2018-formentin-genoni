...
/**
 * The class {@code RestrictionAdjacentViolatedException} its a {@code WindowRestriction} subclass.
 * his form of {@code Throwable} that indicates conditions that a reasonable
 * application might want to catch.
 *
 * <p>The class {@code RestrictionAdjacentViolatedException} and any subclasses are <em>checked
...
public class RestrictionAdjacentViolatedException extends WindowRestriction {
    ...
    /**
     * Constructs a new exception with {@code The restriction of adjacency to a die was violated}
